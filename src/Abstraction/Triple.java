...
public class Triple<A extends Object,B extends Object, C extends Object> {
	  ...
	  public void setFirst(A val) { this.first= val; }
	  public void setSecond(B val) { this.second= val; }
	  public void setThird(C val) { this.third= val; }
	  ...
	  @Override
	  public int hashCode() { return first.hashCode() ^ second.hashCode() ^ third.hashCode(); }
